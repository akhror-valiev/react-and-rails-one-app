...
**["Hello world" project as one app with Webpack]** Implement a connection between a Ruby on Rails back-end and React front-end. Built with ruby on rails and React.
...
```sh
  git clone https://github.com/akhror-valiev/react-and-rails-one-app.git
